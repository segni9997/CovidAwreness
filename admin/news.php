...
<body>
    ...
    <div class="containe">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<p> " . (htmlspecialchars($row['descriptiones'])) . "</p> <br>";
            echo"<a href=\"delteNews.php?imageNo= $row[image_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>";
